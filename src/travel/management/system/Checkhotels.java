...
public class Checkhotels extends JFrame implements Runnable {
    ...
    JLabel[]label = new JLabel[]{l1, l2, l3, l4, l4, l5, l6, l7, l8, l9, l10};
    JLabel caption;
    public void run(){
        String[] text = new String[]{"JW Marriot Hotel","Madarin Hotel","Four Seasons Hotel","Radddison Blue Hotel","Classio Hotel","The Bay Club Hotel","The Taj Hotel","Happy Morning Motel","River View Hotel","Hotel Ritz Paris"};
        try{
            for(int i=0; i<=9; i++){
